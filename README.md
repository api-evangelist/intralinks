...
**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/intralinks/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Virtual Data Room, Document Management, Secure File Sharing
...
- [OpenAPI](openapi/intralinks-api-openapi.yml)
- [JSONSchema](json-schema/workspace.json)
- [JSONSchema](json-schema/document.json)
- [JSONSchema](json-schema/folder.json)
- [JSONSchema](json-schema/group.json)
- [JSONSchema](json-schema/user.json)
- [JSONSchema](json-schema/permission.json)
- [JSONSchema](json-schema/splash.json)
- [JSONSchema](json-schema/custom-field.json)
- [JSONLD](json-ld/intralinks-context.jsonld)
...
- [GettingStarted](https://www.intralinks.com/why-intralinks/apis-deployment)
